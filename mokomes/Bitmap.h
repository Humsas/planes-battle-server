...
private:
    ...
    //methods
    void reset(void);
    bool convert32(unsigned char *);		//convert to 32bit RGB bottom up data
    bool convert24(unsigned char *);		//convert to 24bit RGB bottom up data
    bool convert8(unsigned char *);		//convert to 24bit RGB bottom up data
};
