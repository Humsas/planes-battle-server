...
void SceneManager::LoadObjects()
{
	...
	meshManager->loadMesh("Models/Buildings/","lusna.x","lusna",d3);
	meshManager->loadMesh("Models/Buildings/","lusna2.x","lusna2",d3);
	meshManager->loadMesh("Models/Buildings/Mansion/","mansion.x","mansion",d3);
	meshManager->loadMesh("Models/Buildings/","namas01.x","namas01",d3);
	meshManager->loadMesh("Models/Buildings/","namas1.x","namas1",d3);
	meshManager->loadMesh("Models/Buildings/","namas2.x","namas2",d3);
	meshManager->loadMesh("Models/Buildings/","namas5.x","namas5",d3);
	meshManager->loadMesh("Models/Buildings/","namas6.x","namas6",d3);
	meshManager->loadMesh("Models/Buildings/","namas7.x","namas7",d3);
	meshManager->loadMesh("Models/Buildings/","namas8.x","namas8",d3);
	meshManager->loadMesh("Models/Buildings/","namas9.x","namas9",d3);
	meshManager->loadMesh("Models/Buildings/","store.x","store",d3);
	meshManager->loadMesh("Models/Buildings/","tavern.x","tavern",d3);
